! function (e) {
    ...
    e.fn.meanmenu = function (n) {
        var a = {
            ...
            meanDisplay: "block",
            removeElements: "",
            siteLogo: "<a href='index.php'>Site Logo</a>"
        };
        n = e.extend(a, n);
                ...
                b = function () {
                    ...
                    if (o >= t) {
                        ...
                        jQuery(".mean-nav").html(r), Q && jQuery("nav.mean-nav ul, nav.mean-nav ul *").each(function () {
                            ...
                            jQuery(this).children().length && jQuery(this, "li:first").parent().append('<a class="mean-expand" href="#" style="color:gold;font-size: ' + i + '">' + y + "</a>")
