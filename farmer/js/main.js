(function ($) {
    ...
    $('nav#dropdown').meanmenu({
        siteLogo: "<div class='mobile-menu-back' style='margin-top:12px;margin-bottom:12px'><a href='index.php' class='logo-mobile-menu'><img src='images/logo-v1.png' class='img-responsive' style='margin-top:-15px'/></a></div>"
    });
            ...
            if (windowpos >= topBarH) {
                ...
                if (h3.length) {
                    ...
                    if (h2.find('.temp-main-menu.stick').length == 0) {
                        h2.append(tempMenu);
                        h2.find('.temp-main-menu.stick').animate({
                            opacity: 1
                        }, 100);
                    }
